...
<head>
  ...
  <title>Sistem Pendukung Keputusan Metode MABAC dan Pembobotan Entropy</title>
    ...
    <ul class="navbar-nav bg-gradient-success sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.php">
        <div class="sidebar-brand-icon">
          <img style="border-radius:50%;" src="images/smk.jpg" alt="logo" width="50" height="50">
        </div>
        <div class="sidebar-brand-text mx-3">SPK SISWA BERPRESTASI</div>
      </a>

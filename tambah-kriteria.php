...
if(isset($_POST['submit'])):	
	...
	if(empty($errors)):
		...
		$simpan = mysqli_query($koneksi,"INSERT INTO kriteria (kode_kriteria, nama_kriteria, type, bobot, ada_pilihan) 
		VALUES ('$kode_kriteria', '$nama_kriteria', '$type', '$bobot', '$ada_pilihan')");
		if($simpan) {

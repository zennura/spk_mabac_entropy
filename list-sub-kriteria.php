...
if(isset($_POST['tambah'])):	
	...
	if(empty($errors)):
		$simpan = mysqli_query($koneksi,"INSERT INTO sub_kriteria (id_kriteria, nama_sub_kriteria, nilai_sub_kriteria) VALUES ('$id_kriteria', '$nama_sub_kriteria', '$nilai')");
...
<div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
        <div class="d-sm-flex align-items-center justify-content-between">
			...
			<?= $data['nama_kriteria']." (".$data['kode_kriteria'].")" ?></h6>
			<a href="#tambah<?= $data['id_kriteria']; ?>" data-toggle="modal" class="btn btn-sm btn-success"> 
			...
			<table class="table table-bordered" width="100%" cellspacing="0">
				...
				<tbody>
					<?php 
						...
						$q = mysqli_query($koneksi,"SELECT * FROM sub_kriteria 
						WHERE id_kriteria = '$id_kriteria' ORDER BY nilai_sub_kriteria DESC");			
					...
					<tr align="center">
						...
						<td>
							<div class="btn-group" role="group">
								<a data-toggle="modal" title="Edit Data" href="#editsk<?= $d['id_sub_kriteria'] ?>" 

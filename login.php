                        ...
                        <div class="card-body">
                            <div class="text-center">
                                <div class="text-center card-body p-0">
                                    <p style="font-size: 25px; color:black">SISTEM PENDUKUNG KEPUTUSAN PEMILIHAN SISWA BERPRESTASI DI SMK SULTAN AGUNG PARUNG PANJANG</p>
                                    <p class="text-center card-body p-0 text-center"><img style="border-radius:50%;" src="images/smk.jpg" width="190" height="190"></p>
                                </div>
                            </div>
                            <?php if (!empty($errors)) : ?>
